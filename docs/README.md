...
- [README](../README.md) — user-facing behavior, installation, uninstall, and compatibility summary.
- [STATUS_AND_PLAN.md](STATUS_AND_PLAN.md) — current release status, accepted product contract, and remaining acceptance work.
...
- [ASI_RETAIL_ACCEPTANCE.md](ASI_RETAIL_ACCEPTANCE.md) — additional acceptance required for the ASI loading path.
...
- [RELEASE_NOTES.md](RELEASE_NOTES.md) — notes prepared for the current release target.
...
Names such as `rc.5`, `rc7g`, or `v0.1.0-rc.*` in those files refer to historical development candidates. They are unrelated to the current `v0.2.0-rc.N` release-candidate numbering except as project history.
